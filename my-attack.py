...
def main():
    ...
    output = str_xor(target_cipher.decode('hex'), final_key_hex_decoded)
    print ''.join([char if char in PRINT_SET and index in known_key_positions else '*' for index, char in enumerate(output)])
